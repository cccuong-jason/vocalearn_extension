...
import { TranslationService } from '../../../src/core/domain/ports/translation-service';
import { CacheService } from '../../../src/core/domain/ports/cache-service';
import { Translation } from '../../../src/core/domain/models/translation';
...
describe('TranslateTextUseCase', () => {
  ...
  test('should return cached translations when available', async () => {
    const cachedTranslation: Translation = {
      sourceText: 'Hello',
      targetLanguage: 'es',
      translatedText: 'Hola'
    };
